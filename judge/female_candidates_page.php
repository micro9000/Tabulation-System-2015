...
<html>
                  ...
                  echo "<div class='col-lg-3 col-md-4 col-xs-6 thumb '>";
                    echo "<div class='thumbnail'>";
                      echo "<a href='#' data-toggle='modal' data-target='#candProfile'>";
                        echo "<div class='caption text-center can_name'><p class='can_name_s'><span>".$row['fname'] . " " . $row['lname']."</span></p></div>";
      ...
      -->
        <div class="container">
          <div class="row">
            <?
              //get the female candidate information
              $candidateInfo = $sql->get_female_candidates_info($_SESSION['official_event_id']);
              while($row = mysql_fetch_array($candidateInfo)){
                      ...
                      echo "<div class='col-md-12'>";
                        echo "<div class='row'>";
                          echo "<div class='col-md-6'>";
                            ...
                            $candidateNo = $sql -> get_female_candidates_no($_SESSION['official_event_id'], $row['id']);
                            $cand_female_no = mysql_fetch_array($candidateNo);
                          ...
                          echo "<div class='col-md-6 col-sm-6'>";
                              echo "<p class='info'><span>No : </span>".$cand_female_no['candidate_no']."</p>";
