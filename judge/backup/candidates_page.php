        ...
        <div class="container">
          <div class="row">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
              <?php
                $candidateInfo = $sql->get_candidates_info($_SESSION['official_event_id']);
             ...
             <hr/>
              <footer class="footer">
                <div class="container">
                  ...
                  <p class="text-muted">
                      <span><a href="#">Contact</a> | <a href="#"> Facebook</a></span>
                  </p>
                </div>
              </footer>
            </nav>
