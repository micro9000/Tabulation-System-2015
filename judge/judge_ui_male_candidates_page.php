...
<html>
       ...
       <divclass='header'>
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <h1 style='color:brown'  align="center">Male Candidates</h1>
         ...
         <div class='container-fluid'>
             ...
             <table class="table table-striped table-bordered table-hover">
              <thead>
                ...
                <tr>
                  <th class='td_cand_no'>No.</th>
                  
                  <th class='td_cand_name'>Candidate</th>
                     <?php
                          ...
                          while($row_category = mysql_fetch_array($result_Category)){
                                $category_info = $sql -> get_category_info($row_category['id']);
                                echo "<th class='category_name'>".$row_category['category_name']." (".$category_info['max_score'].") </th>";
                          }
                      ?>
	                              ...
	                              if($cand_score['score']>0){
	                                ...
	                                if(isset($_POST['btn_category_id_'.$row_category['id']."_".$row_candidate['id']])){
	                                  ...
	                                  if($_POST['cat_score_'.$row_candidate['id']."_".$row_category['id']] != ""){
	                                    $insert_cand_score_result = $sql -> insert_candidate_score($row_category['id'], $row_candidate['id'], $_SESSION['official_event_id'], $_SESSION['official_id'], $_SESSION['round_id'], $cat_score, "judge_ui_male_candidates_page.php");
