...
<?php
	...
	//get the candidates
			...
			echo "<h3>Overall Scores : Male Candidates</h3>";
		...
		echo "<div class='container'>";
			echo "<div class='row'>";
					...
					echo "<table class='table table-bordered table-hover' class='table'><tr><th class='lbl'>Rank</th><th class='lbl'>Name</th><th class='lbl'>Overall Score</th></tr>";
					$rank=1;
